...
const CACHE_NAME = "gallo-pos-shell-v2";
...
self.addEventListener("fetch", (event) => {
  ...
  // Primero a la red SIEMPRE (para que las actualizaciones se vean al instante) —
  // la copia guardada solo se usa como respaldo si de plano no hay internet.
  event.respondWith(
    fetch(event.request)
      .then((response) => {
